...
(function (w, z) {
  ...
  function z(x, u) {
    ...
    typeof u === "string"
      ...
      : u instanceof Blob &&
        u.type &&
        q.setRequestHeader("Content-Type", u.type);
    try {
      q.send(u);
    } catch (r) {
      return !1;
  ...
  (function () {
    ...
    typeof this.navigator.sendBeacon !== "function" &&
      (this.navigator.sendBeacon = z.bind(this));
  }).call(
    (typeof window === "undefined" ? "undefined" : w(window)) === "object"
      ? window
      : {},
  );
});
  ...
  var ResponsiveVoice = function () {
          ...
          for (var h = 0; h < q.length; h++) {
            ...
            k
              ? (Array.isArray(k) || (k = [k]),
                c.collectionvoice &&
                  ...
                  k.indexOf(c.collectionvoice.name) != -1 &&
                  (g = !0))
              : (g = !0);
            var f = !1,
              l = e.systemvoices;
            l
              ? (Array.isArray(l) || (l = [l]),
                c.systemvoice &&
                  c.systemvoice.name &&
                  l.indexOf(c.systemvoice.name) != -1 &&
                  (f = !0))
              : (f = !0);
            (k == null || (k != null && g)) &&
              (l == null || (l != null && f)) &&
      ...
      function u() {
        var b = document.getElementsByTagName("script"),
          c;
        for (c = 0; c < b.length; ++c)
          if (b[c].src && A.test(b[c].src)) return ((A.lastIndex = 0), !1);
        return !0;
      }
      var a = this;
      a.version = "1.8.4";
        ...
        a.is_opera || typeof speechSynthesis === "undefined"
          ...
          : setTimeout(function () {
              var b = setInterval(function () {
                ...
                c.length != 0 ||
                (a.systemvoices != null && a.systemvoices.length != 0)
          ...
          if (a.isPlaying())
            ...
            if (e) {
              ...
              if (e.mappedProfile != null) g = e.mappedProfile;
                ...
                ((g.systemvoice = a.getMatchedVoice(e)),
                (g.collectionvoice = {}),
                g.systemvoice == null)
              ) {
              ...
              if (b.length > a.CHARACTER_LIMIT) {
                for (var f = (b = w(b)); f.length > a.CHARACTER_LIMIT; ) {
                  ...
                  var l = "";
                  if (e == -1 || e >= a.CHARACTER_LIMIT)
                    e = f.search(/,[^0-9]+/);
                  if (
                    (e == -1 || e >= a.CHARACTER_LIMIT) &&
                    f.search(" ") != -1
                  ) {
                    var t = f.split(" ");
                    for (e = 0; e < t.length; e++) {
                      if (l.length + t[e].length + 1 > a.CHARACTER_LIMIT) {
                        t[e].length >= a.CHARACTER_LIMIT &&
                          (l += t[e].substr(
                            0,
                            a.CHARACTER_LIMIT - l.length - 1,
                          ));
                        break;
                      }
                      l += (e != 0 ? " " : "") + t[e];
                ...
                for (e = 0; e < k.length; e++)
                  if (
                    ...
                    (a.log("Using SpeechSynthesis"),
                      ...
                      (f.volume = a.selectBest([
                        g.collectionvoice.volume,
                        g.systemvoice.volume,
                        1,
                      ])),
                      (f.rate = a.selectBest([
                        a.iOS9plus ? 1 : null,
                        g.collectionvoice.rate,
                        g.systemvoice.rate,
                        r,
                      ])),
                      (f.pitch = a.selectBest([
                        g.collectionvoice.pitch,
                        g.systemvoice.pitch,
                        1,
                      ])),
                      (f.text = k[e]),
                      (f.lang = a.selectBest([
                        g.collectionvoice.lang,
                        g.systemvoice.lang,
                      ])),
                      (f.rvIndex = e),
                      (f.rvTotal = k.length),
                      ...
                      d != null
                        ? ((f.voice =
                            typeof d.voice !== "undefined"
                              ? d.voice
                              : g.systemvoice),
                          e < k.length - 1 && k.length > 1
                            ? ((f.onend = a.onPartEnd),
                              f.hasOwnProperty("addEventListener") &&
                                f.addEventListener("end", a.onPartEnd))
                            : ((f.onend = a.speech_onend),
                              f.hasOwnProperty("addEventListener") &&
                                f.addEventListener("end", a.speech_onend)),
                          (f.onerror =
                            d.onerror ||
                            function (y) {
                    ...
                    var G =
                      ...
                      (g.collectionvoice.lang ||
                        ...
                        "en-US") +
                      "&sv=" +
                      (g.collectionvoice.service ||
                        g.systemvoice.service ||
                        "") +
                      "&vn=" +
                      (g.collectionvoice.voicename ||
                        g.systemvoice.voicename ||
                        "") +
                      "&pitch=" +
                      f.toString() +
                      "&rate=" +
                    ...
                    typeof rvApiKey == "undefined" &&
                      a.is_wordpress &&
                      (f += "&key=HY7lTyiS");
                    g.collectionvoice.gender !== void 0 &&
      ...
      a.OnFinishedPlaying = function (b) {
        if (a.msgparameters != null && a.msgparameters.onend != null)
          a.msgparameters.onend();
      };
      ...
      a.getSystemVoice = function (b) {
        ...
        if (typeof a.systemvoices === "undefined" || a.systemvoices === null)
          return null;
            ...
            return (
              ...
              (a.fallbackMode =
                a.responsivevoices[c].mappedProfile.collectionvoice
                  .fallbackvoice === !0 || a.forcedFallbackMode === !0
                  ? !0
                  : !1),
              b != a.fallbackMode &&
      ...
      a.checkSpeechAllowed = function (b) {
        ...
        if (
          ...
          (a.allowPermissionPopupEverywhere === !0 ||
            c ||
            d ||
            a.speechSynthesisNotAllowedError === !0) &&
          ...
          a.allowSpeechDiv_appearances =
            a.allowSpeechDiv_appearances == null
              ? 1
              : ++a.allowSpeechDiv_appearances;
          ...
          a.allowSpeechDiv.innerHTML =
            ...
            (b.urlOverride != void 0
              ? b.urlOverride
              : window.location.hostname) +
            "</strong> " +
            (b.textOverride != void 0
              ? b.textOverride
      ...
      a.onPartEnd = function (b) {
        if (a.msgparameters != null && a.msgparameters.onchuckend != null)
          ...
          l = function v(m) {
            return function (n) {
              if (d(n)) var B = [];
                ...
                n = v(m)(e(m)(n));
                if (Array.isArray(n)) {
                  for (var C = 0, E = Array(n.length); C < n.length; C++)
                    E[C] = n[C];
                  n = E;
                } else n = Array.from(n);
                B = H.call(B, n);
